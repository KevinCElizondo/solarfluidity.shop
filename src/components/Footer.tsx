      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-1">
            <h3 className="text-xl font-bold mb-4">SolarFluidity</h3>
            <p className="text-gray-300 mb-4">
              Su fuente especializada en soluciones de energía solar para Costa Rica y toda América.
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/categorias" className="text-gray-300 hover:text-white">Categorías</Link></li>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li><Link href="/categorias/paneles-solares" className="text-gray-300 hover:text-white">Paneles Solares</Link></li>
              <li><Link href="/categorias/kits-completos" className="text-gray-300 hover:text-white">Kits Completos</Link></li>
              <li><Link href="/categorias/baterias" className="text-gray-300 hover:text-white">Baterías</Link></li>
              <li><Link href="/categorias/inversores" className="text-gray-300 hover:text-white">Inversores</Link></li>
              <li><Link href="/categorias/accesorios" className="text-gray-300 hover:text-white">Accesorios</Link></li>
              <li><Link href="/categorias/cursos" className="text-gray-300 hover:text-white">Cursos</Link></li>
            </ul>
          </div>
